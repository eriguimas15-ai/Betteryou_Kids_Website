...
async function main() {
      ...
      sections: {
        create: [
          ...
          },
          {
            ...
            value: 'a natureza inspira',
            sortOrder: 1,
          },
          {
            key: 'hero_title_line3',
            label: 'Linha 3 do título',
            value: 'e a criatividade transforma',
            sortOrder: 2,
          },
          {
  ...
  const serviceActivityMatrix: Array<{
    ...
    // Jardim de Infância = mesmas actividades do Pré-Escolar
    { activity: 'Ginástica', service: 'Jardim de Infância', pricing: 'INCLUDED' },
    { activity: 'Inglês', service: 'Jardim de Infância', pricing: 'INCLUDED' },
    { activity: 'Música', service: 'Jardim de Infância', pricing: 'INCLUDED' },
    ...
    { activity: 'Jiu-Jitsu', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 40000, unit: 'Gika' },
    { activity: 'Ballet', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 40000, unit: 'Gika' },
    { activity: 'Xadrez', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 30000, unit: 'Gika' },
    ...
    { activity: 'Jiu-Jitsu', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 30000, unit: 'Patriota' },
    { activity: 'Ballet', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 30000, unit: 'Patriota' },
    { activity: 'Xadrez', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 25000, unit: 'Patriota' },
    { activity: 'Natação', service: 'Jardim de Infância', pricing: 'PAID', priceAkz: 30000, unit: 'Patriota' },

...
const defaultTestimonials: Testimonial[] = [
    ...
    },
    {
      ...
      content: "O programa de actividades extracurriculares é fantástico. O Lucas faz jiu-jitsu e música, e vemos como essas actividades contribuem para seu desenvolvimento integral.",
      rating: 5,
      service: "ATL",
      image: "👨🏾",
      highlight: "Actividades extracurriculares excepcionais"
    },
    {
      name: "Fernanda Lima",
...
const Testimonials = () => {
  ...
  const partnerships = [
    ...
    },
    {
      ...
      description: "Projectos de educação ambiental",
      icon: "🌱"
    }
  ];
  ...
  return (
    <section id="testimonials" className="pt-32 pb-20 bg-gradient-to-b from-muted/30 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-soft mt-16">

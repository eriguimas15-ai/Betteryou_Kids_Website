...
const Home = () => {
  ...
  const services = [
    ...
    },
    {
      title: "1º Ciclo",
      age: "6-10 anos",
      description: "Acompanhamento pedagógico para o 1º Ciclo, com reforço escolar e actividades de autonomia.",
      image: heroImage
    },
    {
      title: "ATL",
      age: "3-10 anos",
      description: "Actividades de tempos livres que complementam o ensino com diversão e apoio aos estudos.",
      image: natureImage
    },
    {
      ...
      <section className="py-20 bg-gradient-to-b from-green/5 to-blue/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Nossa ampla gama de actividades foi cuidadosamente desenvolvida para estimular o desenvolvimento integral 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="group hover:shadow-colorful transition-all duration-500 hover:scale-105 animate-bounce-in border-t-4 border-t-green" style={{animationDelay: '0.2s'}}>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Jiu-jitsu, actividades ao ar livre e exploração da natureza para desenvolvimento físico completo.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-colorful transition-all duration-500 hover:scale-105 animate-slide-in-right border-t-4 border-t-blue" style={{animationDelay: '0.4s'}}>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Oficinas de arte, teatro e projectos criativos que estimulam a imaginação e autoexpressão.
                </p>
              </CardContent>
            </Card>
          </div>
